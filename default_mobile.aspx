                                            ...
                                            <td id="td_arrow">
                                                <table id="table_change_amount" style="text-align:center; margin:auto">
                                                    <tr>
                                                        ...
                                                        <td style="align-items : center; ">
                                                           <div style="width:70px; text-align: center; color: #363333; font-size: 14px; font-family: Inter; display:inline-block; font-weight: 700; word-wrap: break-word">
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align:center">
                                                <div style="text-align: center;line-height:160%; color: #1E1E1E; font-size: 14px; font-family: Montserrat; font-weight: 400; word-wrap: break-word">
                                                    <div class="div_service_korean" style="text-align: left;">현재 한국 세무회계 중 법인세 분야에 한해서만 서비스를 제공하고 있습니다. 아래의 채팅앱이 비록 OS 0.3 버전 상에서 구동되고 있지만 그런대로 잘 나오는 것을 확인할 수 있습니다. 새로운 시대의 개막을 알리고 있습니다.</div>
                                                    <div class="div_service_english" style="display:none;text-align: left;">Currently, we only provide services in the corporate tax field of Korean tax accounting. Although the chat app below runs on OS 0.3 version, you can see that it is coming out not bad. It marks the beginning of a new era.</div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <td style="padding:30px">
                        <table style="width: 100%;margin:auto;">
                            <tr class="footer_text">
                                <td style="padding:10px; text-align:center; font-size: 30px; font-family: Montserrat; font-weight: 600; word-wrap: break-word">KEngine</td>
                                <td style="margin-top: 25px;text-align:center">
                                    주식회사 KEngine<br/>retelf@naver.com <br/> 경기도 광주시 수레안길 51-3
                                </td>
                            </tr>
                        </table>
                    </td>
